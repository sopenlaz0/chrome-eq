// Object to manage extension functionalities
var app = {};
...
// Event handler for when a connection is established with a port
app.on.connect(function (port) {
  if (port) {
    ...
    // Event listener for incoming messages on the port
